    ...
    <div class="card " style="width: 18rem;">
      <div class="card-body">
        ...
        {{$datosAsignacion->Kam}}</p>
                ...
                <button   class="btn btn-primary" href="#PlaceModal-{{$datosAsignacion->idAsignacion}}" data-toggle="modal">Info del comercio</button>
        <!-- Modal -->
  <div  class="modal fade"  tabindex="-1" id="PlaceModal-{{$datosAsignacion->idAsignacion}}"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Comercio:{{$datosAsignacion->cliente->nombreConsola}} </h5>
        ...
        <p style="width: 450px;" id="textArea"> {{$datosAsignacion->cliente->nombreConsola}}</p>
...
<p>@switch($datosAsignacion->cliente->chatWeb)
  @case(true)
