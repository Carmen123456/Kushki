@extends('layouts.app', [
    'class' => '',
    'elementActive' => 'macrosZendeskbtc',
])
@section('content')
@section('css')
...
<div class="content">
    <div class="row">
            ...
            <a href="{{ route('MacrosZendesk.exportarB2C') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <table id="example"  class="table table-hover table-borderless">
                            ...
                            <tbody>
                                @foreach ($datosZendesk as $MacrosZendesk)
                                    <tr>
                                        <td>{{ $MacrosZendesk->idMacroZendesk }}</td>
                                        <td>
                                            <a href="#PlaceModal-{{ $MacrosZendesk->idMacroZendesk }}"
                                                data-toggle="modal">
