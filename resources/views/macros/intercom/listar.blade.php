...
<div class="content">
    <div class="row">
            ...
            <a href="{{ route('MacrosIntercom.exportarB2B') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                title="Exportar registros B2B"><img class="operaciones" src="{{ asset('paper') }}/icons/Icon_download.svg"
                    alt=""></a>
                    @endcan
                    <div class="col-md-12">
            <div class="card">
      ...
      overflow: hidden;">{{ $MacrosIntercom->mensaje }} </p>
                                            ...
                                            <div class="modal fade" tabindex="-1"
                                                id="PlaceModal-{{ $MacrosIntercom->idMacroIntercom }}" role="dialog"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Respuesta
                                                            </h5>
