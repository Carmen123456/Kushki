                ...
                <form class="col-md-12" action="{{ route('profile.update') }}" method="POST"
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __('Editar Prefil') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Nombre usuario') }}</label>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Correo usuario') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input readonly style="background-color: white" type="email" name="email"
                        ...
                        <div class="card-footer ">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit"
                                    class="btn btn-warning btn-round mb-3">{{ __('Guardar') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
